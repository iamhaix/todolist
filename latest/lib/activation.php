...
<?php
	...
	if($userid){
		...
		echo "<div id='hoho'>亲爱的，恭喜您！您的".$email."账号激活成功!点击<a id='success' href='http://127.0.0.1/workspace/todolist/latest/webFile/main.html'>这里</a>之后跳到soeasy主页....</div><br />";  
	}else{

		echo "<div id='hoho'>亲爱的，对不起！您的".$email."账号激活失败!点击<a href='http://127.0.0.1/workspace/todolist/latest/webFile/main.html'>这里</a>返回soeasy主页....</div><br />";  
	}
?>
</body>
</html>
